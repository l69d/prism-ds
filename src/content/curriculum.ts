...
export const curriculum: Module[] = [
  ...
  },
  {
    ...
    tone: "violet",
    concepts: [
      { slug: "probability-basics", title: "Probability Basics", blurb: "Events, conditional probability, independence, and Bayes' rule.", minutes: 12, status: "live" },
      ...
      { slug: "estimation-and-sampling", title: "Estimation & Sampling", blurb: "Point estimates, bias, variance, and what a 'good' estimator means.", minutes: 11, status: "live" },
      { slug: "confidence-intervals", title: "Confidence Intervals", blurb: "What '95% confident' really means — and what it doesn't.", minutes: 10, status: "live" },
      ...
      { slug: "bayesian-thinking", title: "Bayesian Thinking", blurb: "Priors, likelihoods, posteriors — updating beliefs with evidence.", minutes: 13, status: "live" },
      { slug: "ab-testing", title: "A/B Testing Foundations", blurb: "Designing an experiment that can actually answer your question.", minutes: 12, status: "live" },
    ],
  },
  {
    id: "wrangling",
  ...
  },
  {
    ...
    concepts: [
      ...
      { slug: "ab-testing-in-practice", title: "A/B Testing in Practice", blurb: "Power, peeking, CUPED, and shipping decisions you can defend.", minutes: 12, status: "live" },
